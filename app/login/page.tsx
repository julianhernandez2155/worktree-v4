  ...
  return (
    <div className="min-h-screen bg-dark-bg relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-neon-blue/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2 gradient-text">Worktree</h1>
          <p className="text-gray-400">Bridge campus to career</p>
        </div>
