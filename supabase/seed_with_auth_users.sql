...
-- This version creates auth users first, then profiles
...
-- STEP 2: Now run the rest of the seed data
...
BEGIN
  ...
  RAISE NOTICE 'All test users have password: temp_password_123';
